...
for id in range(len(dataset_id)):
    ...
    VGG11_optimal = torch.load(f"VGG11 optimal {id}.pt")
    target_layers = [VGG11_optimal.features[-1]]
    targets = [ClassifierOutputTarget(1)]
    cam = GradCAM(model=VGG11_optimal, target_layers=target_layers, use_cuda=True)
    ...
    results_df.append([f"VGG-11", f"{id}", f"Grad-CAM", f"Optic cup",
    ...
    results_df.append([f"VGG-11", f"{id}", f"Grad-CAM", f"Optic disk",
    ...
    results_df.append([f"VGG-11", f"{id}", f"Grad-CAM", f"Blood vessels",
...
pd.DataFrame(results_df).to_csv("explanation_vgg_11_grad_cam_cross_validation.csv", index=False, encoding="cp1252")
...
results_df_full.append([f"VGG-11", f"Grad-CAM", f"Optic cup",
                        f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                        f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                        f"{hau_oc_mean} ({hau_oc_std})"])
...
results_df_full.append([f"VGG-11", f"Grad-CAM", f"Optic disk",
                        f"{xai_od_mean} ({xai_od_std})",
                        f"{od_fundus_mean} ({od_fundus_std})",
                        f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
...
results_df_full.append([f"VGG-11", f"Grad-CAM", f"Blood vessels",
                        f"{xai_bv_mean} ({xai_bv_std})",
                        f"{bv_fundus_mean} ({bv_fundus_std})",
                        f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df_full).to_csv("explanation_vgg_11_grad_cam_aggregation.csv", index=False, encoding="cp1252")
...
for id in range(len(dataset_id)):
    ...
    target_layers = [VGG11_optimal.features[-1]]
    targets = [ClassifierOutputTarget(1)]
    cam = XGradCAM(model=VGG11_optimal, target_layers=target_layers, use_cuda=True)
    ...
    results_df.append([f"VGG-11", f"{id}", f"XGrad-CAM", f"Optic cup",
                       f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                       f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                       f"{hau_oc_mean} ({hau_oc_std})"])
    ...
    results_df.append([f"VGG-11", f"{id}", f"XGrad-CAM", f"Optic disk",
                       f"{xai_od_mean} ({xai_od_std})",
                       f"{od_fundus_mean} ({od_fundus_std})",
                       f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
    ...
    results_df.append([f"VGG-11", f"{id}", f"XGrad-CAM", f"Blood vessels",
                       f"{xai_bv_mean} ({xai_bv_std})",
                       f"{bv_fundus_mean} ({bv_fundus_std})",
                       f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df).to_csv("explanation_vgg_11_XGrad_cam_cross_validation.csv", index=False, encoding="cp1252")
...
results_df_full.append([f"VGG-11", f"XGrad-CAM", f"Optic cup",
                        f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                        f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                        f"{hau_oc_mean} ({hau_oc_std})"])
...
results_df_full.append([f"VGG-11", f"XGrad-CAM", f"Optic disk",
                        f"{xai_od_mean} ({xai_od_std})",
                        f"{od_fundus_mean} ({od_fundus_std})",
                        f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
...
results_df_full.append([f"VGG-11", f"XGrad-CAM", f"Blood vessels",
                        f"{xai_bv_mean} ({xai_bv_std})",
                        f"{bv_fundus_mean} ({bv_fundus_std})",
                        f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df_full).to_csv("explanation_vgg_11_XGrad_cam_aggregation.csv", index=False, encoding="cp1252")
...
for id in range(len(dataset_id)):
    ...
    target_layers = [VGG11_optimal.features[-1]]
    targets = [ClassifierOutputTarget(1)]
    cam = ScoreCAM(model=VGG11_optimal, target_layers=target_layers, use_cuda=True)
    ...
    results_df.append([f"VGG-11", f"{id}", f"Score-CAM", f"Optic cup",
                       f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                       f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                       f"{hau_oc_mean} ({hau_oc_std})"])
    ...
    results_df.append([f"VGG-11", f"{id}", f"Score-CAM", f"Optic disk",
                       f"{xai_od_mean} ({xai_od_std})",
                       f"{od_fundus_mean} ({od_fundus_std})",
                       f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
    ...
    results_df.append([f"VGG-11", f"{id}", f"Score-CAM", f"Blood vessels",
                       f"{xai_bv_mean} ({xai_bv_std})",
                       f"{bv_fundus_mean} ({bv_fundus_std})",
                       f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df).to_csv("explanation_vgg_11_Score_cam_cross_validation.csv", index=False, encoding="cp1252")
...
results_df_full.append([f"VGG-11", f"Score-CAM", f"Optic cup",
                        f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                        f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                        f"{hau_oc_mean} ({hau_oc_std})"])
...
results_df_full.append([f"VGG-11", f"Score-CAM", f"Optic disk",
                        f"{xai_od_mean} ({xai_od_std})",
                        f"{od_fundus_mean} ({od_fundus_std})",
                        f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
...
results_df_full.append([f"VGG-11", f"Score-CAM", f"Blood vessels",
                        f"{xai_bv_mean} ({xai_bv_std})",
                        f"{bv_fundus_mean} ({bv_fundus_std})",
                        f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df_full).to_csv("explanation_vgg_11_Score_cam_aggregation.csv", index=False, encoding="cp1252")
...
for id in range(len(dataset_id)):
    ...
    target_layers = [VGG11_optimal.features[-1]]
    targets = [ClassifierOutputTarget(1)]
    cam = EigenCAM(model=VGG11_optimal, target_layers=target_layers, use_cuda=True)
    ...
    results_df.append([f"VGG-11", f"{id}", f"Eigen-CAM", f"Optic cup",
                       f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                       f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                       f"{hau_oc_mean} ({hau_oc_std})"])
    ...
    results_df.append([f"VGG-11", f"{id}", f"Eigen-CAM", f"Optic disk",
                       f"{xai_od_mean} ({xai_od_std})",
                       f"{od_fundus_mean} ({od_fundus_std})",
                       f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
    ...
    results_df.append([f"VGG-11", f"{id}", f"Eigen-CAM", f"Blood vessels",
                       f"{xai_bv_mean} ({xai_bv_std})",
                       f"{bv_fundus_mean} ({bv_fundus_std})",
                       f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df).to_csv("explanation_vgg_11_Eigen_cam_cross_validation.csv", index=False, encoding="cp1252")
...
results_df_full.append([f"VGG-11", f"Eigen-CAM", f"Optic cup",
                        f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                        f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                        f"{hau_oc_mean} ({hau_oc_std})"])
...
results_df_full.append([f"VGG-11", f"Eigen-CAM", f"Optic disk",
                        f"{xai_od_mean} ({xai_od_std})",
                        f"{od_fundus_mean} ({od_fundus_std})",
                        f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
...
results_df_full.append([f"VGG-11", f"Eigen-CAM", f"Blood vessels",
                        f"{xai_bv_mean} ({xai_bv_std})",
                        f"{bv_fundus_mean} ({bv_fundus_std})",
                        f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df_full).to_csv("explanation_vgg_11_Eigen_cam_aggregation.csv", index=False, encoding="cp1252")
...
for id in range(len(dataset_id)):
    ...
    target_layers = [VGG11_optimal.features[-1]]
    targets = [ClassifierOutputTarget(1)]
    cam = LayerCAM(model=VGG11_optimal, target_layers=target_layers, use_cuda=True)
    ...
    results_df.append([f"VGG-11", f"{id}", f"Layer-CAM", f"Optic cup",
                       f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                       f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                       f"{hau_oc_mean} ({hau_oc_std})"])
    ...
    results_df.append([f"VGG-11", f"{id}", f"Layer-CAM", f"Optic disk",
                       f"{xai_od_mean} ({xai_od_std})",
                       f"{od_fundus_mean} ({od_fundus_std})",
                       f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
    ...
    results_df.append([f"VGG-11", f"{id}", f"Layer-CAM", f"Blood vessels",
                       f"{xai_bv_mean} ({xai_bv_std})",
                       f"{bv_fundus_mean} ({bv_fundus_std})",
                       f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                       f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df).to_csv("explanation_vgg_11_Layer_cam_cross_validation.csv", index=False, encoding="cp1252")
...
results_df_full.append([f"VGG-11", f"Layer-CAM", f"Optic cup",
                        f"{xai_oc_mean} ({xai_oc_std})", f"{oc_fundus_mean} ({oc_fundus_std})",
                        f"{oc_difference_mean} ({oc_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_oc_mean} ({iou_oc_std})", f"{dice_oc_mean} ({dice_oc_std})",
                        f"{hau_oc_mean} ({hau_oc_std})"])
...
results_df_full.append([f"VGG-11", f"Layer-CAM", f"Optic disk",
                        f"{xai_od_mean} ({xai_od_std})",
                        f"{od_fundus_mean} ({od_fundus_std})",
                        f"{od_difference_mean} ({od_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_od_mean} ({iou_od_std})", f"{dice_od_mean} ({dice_od_std})",
...
results_df_full.append([f"VGG-11", f"Layer-CAM", f"Blood vessels",
                        f"{xai_bv_mean} ({xai_bv_std})",
                        f"{bv_fundus_mean} ({bv_fundus_std})",
                        f"{bv_difference_mean} ({bv_difference_std})", f"{format(p_value, '.3e')}",
                        f"{iou_bv_mean} ({iou_bv_std})", f"{dice_bv_mean} ({dice_bv_std})",
...
pd.DataFrame(results_df_full).to_csv("explanation_vgg_11_Layer_cam_aggregation.csv", index=False, encoding="cp1252")
